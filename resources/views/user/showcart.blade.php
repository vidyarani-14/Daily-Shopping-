...
<div style="padding: 100px;" align="center">
    <table>
        <tr style="background-color: black;">
            <td style="padding: 20px; font-size: 20px; color:white">Product Name</td>
            <td style="padding: 20px; font-size: 20px; color:white">Quantity</td>
            <td style="padding: 20px; font-size: 20px;color:white">Price</td>

            <td style="padding: 20px; font-size: 20px;color:white">Action</td>
        </tr>
